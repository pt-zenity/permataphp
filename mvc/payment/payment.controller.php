...
class PaymentController
{
    public function index(): void
    {
        ...
        if (isset($vaReq['paymentRequestId'])) {
            $vaCheck = cekauthorizationTrx($headers, $request, 'payment');
            $agen    = $vaCheck['agen'];
            ...
            if ($vaCheck['rc'] === '' && $vaCheck['error'] === '') {
                ...
                if ($now >= TutupPPOB::AKHIRTAHUN_FROMTIME && $now <= TutupPPOB::AKHIRTAHUN_TOTIME) {
                    $response = json_encode([
                        'responseCode'    => TutupPPOB::AKHIRTAHUN_RCRS,
                    ...
                    if (json_last_error() !== JSON_ERROR_NONE) {
                        ...
                        $rc               = '4042515';
                        $msg              = 'Transaction Not Permitted. Invalid Response of Payment 1';
            ...
            $agen             = '';
            $vaCheck['rc']    = '4042515';
            $vaCheck['error'] = 'Transaction Not Permitted. Invalid Request of Payment';
            $response         = json_encode([
                'responseCode'    => $vaCheck['rc'],
                'responseMessage' => $vaCheck['error'],
            ]);
